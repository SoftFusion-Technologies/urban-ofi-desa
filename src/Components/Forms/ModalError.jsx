...
const ModalError = ({ isVisible, onClose, textoModal }) => {
  ...
  const mensaje =
    textoModal ??
    'Lamentablemente no se pudo recibir tu información, por favor, intenta nuevamente recargando la página, y si el problema persiste, comunicate a nuestro WhatsApp.';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="uppercase titulo text-center text-blue-600 text-base leading-relaxed font-sans px-2">
          {mensaje}
        </p>
      </div>
    </div>
